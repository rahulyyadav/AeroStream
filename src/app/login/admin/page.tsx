...
export default function AdminLoginPage() {
  ...
  const handlePasswordLogin = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // TODO: Implement admin role checking here
      router.push("/dashboard/admin"); // Replace with your desired admin dashboard path
    } catch (err: any) {
          ...
          <button
            ...
            className={`mr-2 px-4 py-2 rounded-md text-sm font-medium ${
              loginMethod === "password"
                ? "bg-purple-600 text-white" // Active state color
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="appearance-none block w-full px-3 py-2 border border-gray-600 rounded-md shadow-sm placeholder-gray-500 focus:outline-none focus:ring-purple-500 focus:border-purple-500 sm:text-sm bg-gray-700 text-white pr-10"
